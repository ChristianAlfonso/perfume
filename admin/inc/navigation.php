...
<aside class="main-sidebar sidebar-dark-primary elevation-4 sidebar-no-expand">
    <!-- Brand Logo -->
    <a href="<?php echo base_url ?>admin" class="brand-link text-sm" style="background-color: #193F82">
                ...
                <div class="os-content" style="padding: 0px 8px; height: 100%; width: 100%;">
                    ...
                    <nav class="mt-4">
                        <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item dropdown">
                                <a href="<?php echo base_url ?>admin/?page=staff/staff_registration" class="nav-link staff/staff_registration">
                            ...
                            <li class="nav-item dropdown">
                                <a href="<?php echo base_url ?>admin/?page=staff/staff_list" class="nav-link nav-staff/staff_list">
                                    <i class="nav-icon fas fa-th-list"></i>
                                    <p>
                                        Staff List
                                    </p>
