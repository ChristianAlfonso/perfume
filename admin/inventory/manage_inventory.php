...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="inventory-form">
            ...
            <div class="form-group">
				<label for="size" class="control-label">Size (e.g., ml)</label>
                <input type="text" class="form-control" required name="size" value="<?php echo isset($size) ? $size : '' ?>" placeholder="Enter size (e.g., 500ml)">
			</div>
            <div class="form-group">
