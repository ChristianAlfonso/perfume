<nav class="navbar navbar-expand-lg navbar-dark p-4" style="background-color: #193F82">
            ...
            <div class="container px-4 px-lg-5 " >
                ...
                <div class="w-100 d-flex justify-content-between align-items-center">
                  ...
                  <?php echo $_settings->info('short_name') ?>
                    ...
                    <div class="input-group">
                      <input class="form-control form-control-sm form p-3" type="search" placeholder="Search" aria-label="Search" name="search"  value="<?php echo isset($_GET['search']) ? $_GET['search'] : "" ?>"  aria-describedby="button-addon2">
                      <div class="input-group-append">
                        <button class="btn bg-primary btn-light btn-sm m-0" type="submit" id="button-addon2"><i class="fa fa-search"></i></button>
                      </div>
                    </div>
                  </div>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0 ms-lg-4">
                        ...
                        <li class="nav-item"><a class="nav-link text-light" aria-current="page" href="./?p=products&c=<?php echo md5($crow['id']) ?>"><?php echo $crow['category'] ?></a></li>
